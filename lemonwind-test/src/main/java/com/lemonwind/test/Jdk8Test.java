...
public class Jdk8Test {
    ...
    public static void test01() {
        ...
        Integer totalAge = Stream.iterate(0, x -> x + 1).limit(10)
                .map(i -> new com.lemonwind.common.entity.bean.JoUser(i, String.valueOf(i), i % 3, "北京" + i, new Date()))
                .collect(Collectors.reducing(0, com.lemonwind.common.entity.bean.JoUser::getAge, Integer::sum));

        // 年龄分组，取得组中ID最大的对象
        Map<Integer, Optional<com.lemonwind.common.entity.bean.JoUser>> maxIdMap = Stream.iterate(0, x -> x + 1).limit(10)
                .map(i -> new com.lemonwind.common.entity.bean.JoUser(i, String.valueOf(i), i % 3, "北京" + i, new Date()))
                .collect(groupingBy(com.lemonwind.common.entity.bean.JoUser::getAge, maxBy(Comparator.comparing(com.lemonwind.common.entity.bean.JoUser::getId))));

        // 年龄分组，取得组中ID最大的对象
        Map<Integer, com.lemonwind.common.entity.bean.JoUser> maxIdMap2 = Stream.iterate(0, x -> x + 1).limit(10)
                .map(i -> new com.lemonwind.common.entity.bean.JoUser(i, String.valueOf(i), i % 3, "北京" + i, new Date()))
                .collect(
                        groupingBy(
                                com.lemonwind.common.entity.bean.JoUser::getAge,
                                collectingAndThen(maxBy(Comparator.comparing(com.lemonwind.common.entity.bean.JoUser::getId)), Optional::get)
                        )
                );
        ...
        Map<Integer, List<Integer>> sumIdMap = Stream.iterate(0, x -> x + 1).limit(10)
                .map(i -> new com.lemonwind.common.entity.bean.JoUser(i, String.valueOf(i), i % 3, "北京" + i, new Date()))
                .collect(
                        groupingBy(com.lemonwind.common.entity.bean.JoUser::getAge, mapping(user -> user.getId(), toList()))
                );

        // 分区，分区组的 KEY 是布尔型
        Map<Boolean, List<com.lemonwind.common.entity.bean.JoUser>> partitionMap = Stream.iterate(0, x -> x + 1).limit(10)
                .map(i -> new com.lemonwind.common.entity.bean.JoUser(i, String.valueOf(i), i % 3, "北京" + i, new Date()))
