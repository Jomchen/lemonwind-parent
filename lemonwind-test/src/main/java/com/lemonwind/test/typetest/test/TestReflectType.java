package com.lemonwind.test.typetest.test;


import com.lemonwind.test.typetest.entity.*;
import com.lemonwind.test.typetest.jicheng.JoExtends;
import com.lemonwind.test.typetest.jicheng.JoMulExtends;
import com.lemonwind.test.typetest.jicheng.impl.JoUserExtendsImpl;
import com.lemonwind.test.typetest.jicheng.impl.JoUserMulExtendsImpl;
import com.lemonwind.test.typetest.jiekou.JoInterface;
import com.lemonwind.test.typetest.jiekou.JoMulInterface;
import com.lemonwind.test.typetest.jiekou.impl.JoUserInterfaceImpl;
import com.lemonwind.test.typetest.jiekou.impl.JoUserMulInterfaceImpl;
