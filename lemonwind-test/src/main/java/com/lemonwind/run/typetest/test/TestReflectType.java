package com.lemonwind.run.typetest.test;


import com.lemonwind.run.typetest.entity.*;
import com.lemonwind.run.typetest.jicheng.JoExtends;
import com.lemonwind.run.typetest.jicheng.JoMulExtends;
import com.lemonwind.run.typetest.jicheng.impl.JoUserExtendsImpl;
import com.lemonwind.run.typetest.jicheng.impl.JoUserMulExtendsImpl;
import com.lemonwind.run.typetest.jiekou.JoInterface;
import com.lemonwind.run.typetest.jiekou.JoMulInterface;
import com.lemonwind.run.typetest.jiekou.impl.JoUserInterfaceImpl;
import com.lemonwind.run.typetest.jiekou.impl.JoUserMulInterfaceImpl;
